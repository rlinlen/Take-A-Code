...
class DictViewDetail extends React.Component {
    constructor(props){
        super(props);
        //this.state = {};
    ...
    fetchList = () => {
        axios.get(`/api/dict/${this.props.match.params.id}`).then(
            res => {
                //console.log(res);
                this.setState({items: res.data.DictionaryItem, selected: {}, selectAll: 0}, 
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-12">
                            <h4> Total dictionary items: {this.state.items.length}</h4>
                            <div>
                                <ReactTable 
